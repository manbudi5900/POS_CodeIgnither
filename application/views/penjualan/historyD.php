...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class="fa fa-cube fa-fw"></i> Barang <i class="fa fa-angle-right fa-fw"></i> List Penjualan Lengkap</h5>
			<hr>
			...
			<div class="table-responsive">
				...
				<hr>
				<div id="result" style="border-radius: 25px;"></div>
	...
	<div class="modal fade modal-admin" id="nota" tabindex="1"  role="dialog" aria-labelledby="exampleModalLabel" >
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Kasir/history2",
   method:"POST",
   data:{query:query},
