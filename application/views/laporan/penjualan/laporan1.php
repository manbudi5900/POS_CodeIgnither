...
?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('laporan/pdf/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo base_url('assets/dist/img/pdf.png')?>"> Export ke PDF</a>
		<a href="<?php echo site_url('laporan/excel/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo base_url('assets/dist/img/xls.png')?>"> Export ke Excel</a>
	</p>
	<br />
<?php } ?>
